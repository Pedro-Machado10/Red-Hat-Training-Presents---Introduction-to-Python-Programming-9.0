...
> **Nota sobre Lógica:** Python considera `False` valores como: `0`, `False`, `None`, strings vazias `""` ou listas vazias `[]`. Qualquer outro valor é considerado `True`.
...
*   **Suite:** O bloco de código indentado (geralmente 4 espaços).
